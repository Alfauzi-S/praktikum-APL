    ...
    while (true) {
        ...
        if (pilihan == "1") {
            if (mabelIndex == 0) {
                ...
                if (!(cin >> targetId)) {
                    cout << "Input ID tidak valid. Harus berupa angka." << endl;
                    cin.clear();
    ...
    while (true) {
        ...
        if (pilihan == "1") {
            ...
            if (mabelIndex == 0) {
                ...
                tampilkanMabel();
                cout << "\nProduk berhasil diurutkan berdasarkan ID Produk (Ascending)!" << endl;
                system("pause");
            }
        } else if (pilihan == "0") {
            break;
...
void updateFieldProduk(produk *pProduk) {
    ...
    if (updatePilihan == "1") {
        int updateId;
        cout << "Masukkan ID Produk Baru (angka): ";
        if (!(cin >> updateId)) {
...
void updateProduk() {
    ...
    try {
        updateId = stoi(updateIdStr);
    } catch (const std::invalid_argument& e) {
        cout << "ID Produk harus berupa angka. Update dibatalkan." << endl;
        system("pause");
        return;
    }
...
void createProduk(int *pMabelIndex) {
    ...
    if (*pMabelIndex >= maxproduk) {
        ...
        getline(cin, idBaruStr);

        try {
            idBaru = stoi(idBaruStr);
        } catch (const std::invalid_argument& e) {
            cout << "ID Produk harus berupa angka. Produk gagal ditambahkan." << endl;
            system("pause");
            return;
        }
...
void deleteProduk() {
    ...
    try {
        ...
        cout << "ID Produk harus berupa angka. Penghapusan dibatalkan." << endl;
        system("pause");
        return;
    }
...
void beli(string currentUser) {
    ...
    getline(cin, beliIdStr);

    try {
        beliId = stoi(beliIdStr);
    } catch (const std::invalid_argument& e) {
        cout << "ID Produk harus berupa angka. Pembelian dibatalkan." << endl;
        system("pause");
        return;
    }
